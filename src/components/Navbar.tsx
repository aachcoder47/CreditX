            ...
            <div className="relative">
              <div className="flex items-center rounded-xl bg-white/[0.04] border border-white/15 p-0.5 sm:p-1 gap-1 sm:gap-1.5">
                ...
                <button
                  ...
                  className="p-1 sm:px-2 sm:py-1 rounded-lg bg-white/10 hover:bg-white/20 text-slate-300 border border-white/10 text-[11px] font-mono font-semibold flex items-center gap-1 transition-colors"
                ...
                <button
                  ...
                  className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-1 rounded-lg bg-white/5 hover:bg-white/10 text-[11px] sm:text-xs font-mono text-slate-200 transition-colors"
                >
